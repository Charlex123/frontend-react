...
const Contact = () => {
    ...
    const baseUrl = 'https://mi-linux.wlv.ac.uk/~XXXXXX/codeigniterbackend/sendmessage';
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 m-auto text-center">
                            <h1>Contact Us</h1>
                            <p>Can build communication through following </p>
                        </div>
                    </div>
                </div>
            </header>
                        ...
                        <div className="col-md-4">
                            <div className="card p-4">
                                <div className="card-body">
                                    <h4>Get In Touch</h4>
                                    <p>Get in touch through this site __ </p>
                                    <h4>Address</h4>
